 ...
 */
public class UploadPickPhotoActivity extends Activity implements UploadView {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == PICK_PHOTO) {
            if (data == null) {
                ...
                Uri uri;
                uri = data.getData();
                Uri fileUri = UploadManager.convertUri(this, uri, MyApplication.getmPersonBean().getAccount());
                Log.i("personfragment", "pick success");
