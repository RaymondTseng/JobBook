...
//    public static final String IP = "http://192.168.1.18";
    ...
    public static final String QUESTION_URL = IP + "/jobBook/question/allQuestions";

    public static final String QUESTION_DETAIL_URL = IP + "/jobBook/question/getQuestion/q_id/";

    public static final String NEW_QUESTION_URL = IP + "/jobBook/question/releaseQuestion";

    public static final String SEND_QUESTION_COMMENT_URL = IP + "/jobBook/question/comment";
